...
const faqGroups = [
  {
    ...
    items: [
      ...
      { q: 'How do I start using Real Cost?', a: 'Open the software and start your 14-day free trial — no credit card required. Upload a PDF drawing set, create a project, and your team can begin estimating right away. Most users are quoting their first job within minutes.' },
      { q: 'Can I upload PDF drawings and take off quantities directly?', a: 'Yes. Real Cost lets you upload PDF drawing sets and work directly on them in the software, so you can measure, price, and build your estimate in one place without switching between tools.' },
  ...
  return (
    <div className="page-enter">
      ...
      <section className="page-hero">
        ...
        <div className="page-hero-bg" style={{ backgroundImage: `url(${process.env.PUBLIC_URL + '/images/faq/faq.png'})` }} />
